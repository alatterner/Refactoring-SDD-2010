...
public class GeneratePolygonPanel extends JPanel implements Observer {
	...
	public GeneratePolygonPanel(final PolygonModel polygonModel,
			final ConsolePanel consolePanel,
			final ColorSchemeController colorSchemeController) {
		super();
	...
	private void createButtons(final ConsolePanel consolePanel) {
		GeneratePolygonController polygonController = new GeneratePolygonController(
				pModel, seedField, guessesField, verticesField);
		ClearConsoleController clearConsoleController = new ClearConsoleController(
				consolePanel.consoleOutput);
