...
public class ScorePanel extends JPanel implements Observer {
	...
	public void update(final Observable observable, final Object arg) {
		guessedArea
				.setText(String.format("<html>Guessed Area:<P> %.4f </html>",
						pModel.getGuessedArea()));
		actualArea.setText(String.format("<html>Actual Area:<P> %.4f </html>",
				pModel.getPoly().getArea()));
		score.setText(String.format(
				"<html>SCORE: <P><font color=#ff0000> %.4f </font></html>",
				pModel.getScore()));
	}
