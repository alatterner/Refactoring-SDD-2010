...
public class AreaLoaderTest {
	...
	@Test
	public void testCreateAreaLoader() throws MalformedURLException, ClassNotFoundException, 
											  IllegalArgumentException, SecurityException, 
											  InstantiationException, IllegalAccessException,
											  InvocationTargetException, NoSuchMethodException {
		PolygonModel testModel = new PolygonModel();
		String fileName = "resources/PolygonArea.class";
		StudentsClassLoader testLoader = new StudentsClassLoader(fileName,
				testModel);
		assertTrue("Did not get an instance of PolygonArea",
				testLoader.getInstance() instanceof PolygonAreaIF);
	}
}
