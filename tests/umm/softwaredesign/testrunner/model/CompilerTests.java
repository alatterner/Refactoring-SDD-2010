...
public class CompilerTests {
	...
	public final void testReturnFileExtension() {
		...
		final String[] testNameAndExt = CheckAndCompileFile
				.getFileNameAndExt(file);
		assertEquals("File name is \"test.txt\"", "test.txt", file.getName());
		assertEquals("File name (sans extension) should be \"test\"", "test",
				testNameAndExt[0]);
		assertEquals("File extension should be \"txt\"", "txt",
				testNameAndExt[1]);
	}

	@Test(expected = IOException.class)
	public void wrongExtensionFails() throws IOException,
	...
	@Test
	public void testCompiledFile() throws IOException, ClassNotFoundException,
	...
	@Test
	public void compileAFileFail() throws IOException,
